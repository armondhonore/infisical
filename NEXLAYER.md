...
**Live:** [https://relaxed-weasel-infisical.cloud.nexlayer.ai](https://relaxed-weasel-infisical.cloud.nexlayer.ai)  
...
**infisical** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/infisical/infisical:latest-postgres
    path: /
    servicePorts:
    - 8080
    vars:
      DATABASE_URL: "postgresql://infisical:infisical@postgres.pod:5432/infisical"
      REDIS_URL: "redis://redis.pod:6379"
      ENCRYPTION_KEY: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4"
      AUTH_SECRET: "e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6"
      SITE_URL: "https://relaxed-weasel-infisical.cloud.nexlayer.ai"
